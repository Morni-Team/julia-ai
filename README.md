...
- **Content-Modul: schöner und einfacher** – der „Content"-Tab ist aufgeräumt: Du trägst zuerst nur deinen **YouTube-Kanal-Link** ein (optional – es geht auch direkt ohne, z. B. um gleich ein Video prüfen zu lassen), wählst den **Arbeits-/Speicherordner bequem per Auswahl-Dialog** (kein Pfad mehr tippen), und **Logo, Soundeffekte, Farben & Co. macht Julia selbst** und legt alles in diesem Ordner ab. Die Analyse-Details klappst du unten unter „Analyse" auf. Feinschliff (Regeln & Stil) steckt in einem eigenen aufklappbaren Bereich.
