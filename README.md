...
- **Wissensgraph – Julia merkt sich Zusammenhänge** – neben dem freien Gedächtnis hat Julia jetzt einen **Wissensgraphen**: kleine „Bausteine" (Personen, Projekte, Apps, Orte …) mit Notizen, dazu **Verknüpfungen** zwischen ihnen (z. B. „Morni – arbeitet an → Julia"). So kann sie Zusammenhänge gezielt nachschlagen und ergänzen, statt alles in einem langen Text zu suchen. Läuft rein lokal (eigene Datei), Zugangsdaten werden nie gespeichert; der Überblick steht der KI im Kontext bereit, Details holt sie sich mit den neuen Graph-Werkzeugen (in der abschaltbaren Kategorie „Gedächtnis").
