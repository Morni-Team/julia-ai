...
contextBridge.exposeInMainWorld('julia', {
  ...
  contentBlenderStatus: () => ipcRenderer.invoke('content:blender-status'),
  contentThumbnail3d: (opts) => ipcRenderer.invoke('content:thumbnail-3d', opts || {}),
  contentThumbnail3dAuto: (opts) => ipcRenderer.invoke('content:thumbnail-3d-auto', opts || {}),
  onBlenderFortschritt: (cb) => { const h = (_e, p) => cb(p); ipcRenderer.on('content:blender-fortschritt', h); return () => ipcRenderer.removeListener('content:blender-fortschritt', h); },
